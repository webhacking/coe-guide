...
## Hystrix란?
서비스들이 많은 의존성을 가진 분산환경에서는 의존성으로 인한 장애나 지연이 발생하고 **예기치 못한 시점에 실패할 가능성이 존재**한다.  
...
> [circuit 관련 설정 참고](https://github.com/Netflix/Hystrix/wiki/Configuration#circuit-breaker)
